...
const ProfileEdit = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      try {
        ...
        console.log('Profile saved to localStorage and event dispatched');
      } catch (storageError) {
        console.error('ローカルストレージ更新エラー:', storageError);
      }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      {/* ヘッダー */}
      <div className="mb-8">
        <Button variant="text" onClick={() => navigate('/mypage')} className="mb-4">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <div className="p-6">
          ...
          {/* 利用プラン表示 */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">利用プラン</h2>
            
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="flex items-center mb-4">
                <CreditCard className="w-5 h-5 mr-2 text-indigo-600" />
                <h3 className="text-lg font-medium text-gray-900">{userPlan.name}</h3>
